...
dbWriteTable(dbcon_mysql, name="authorfact", value = author_df, append = TRUE, row.names = FALSE)
```
...
```{sql connection=dbcon_mysql}
SELECT id,author_name AS author, num_articles AS 'Number of Articles'
FROM AuthorFact
